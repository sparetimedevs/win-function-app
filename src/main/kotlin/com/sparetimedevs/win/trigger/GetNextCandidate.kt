...
import com.sparetimedevs.win.trigger.handler.handleSuccessWithDefaultHandler
...
class GetNextCandidate(
    ...
    fun get(
        ...
        handleBlocking(
            f = { candidateService.determineNextCandidate().toResponse() },
            success = { nextCandidate -> handleSuccessWithDefaultHandler(request, nextCandidate) },
