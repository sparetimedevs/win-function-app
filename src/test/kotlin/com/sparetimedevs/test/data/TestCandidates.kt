...
private val candidate1 = Candidate(name = "Rose", dates = listOf(date2, date5, date6))
private val candidate2 = Candidate(name = "Joseph", dates = listOf(date1, date4))
private val candidate3 = Candidate(name = "Tommy")
private val candidate4 = Candidate(name = "Abbie", dates = listOf(date3))
