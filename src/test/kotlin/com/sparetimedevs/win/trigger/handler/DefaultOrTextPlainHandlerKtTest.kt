...
import com.sparetimedevs.pofpaf.http.handleSuccessWithDefaultHandler
...
class DefaultOrTextPlainHandlerKtTest : BehaviorSpec({
    ...
    mockkStatic("com.sparetimedevs.pofpaf.http.SuccessHandlerKt")
        ...
        and("contains application/json") {
            `when`("handleSuccessWithDefaultOrTextPlainHandler") {
                then("returns all candidates in application/json format") {
                    ...
                    val result = handleSuccessWithDefaultOrTextPlainHandler(request, context, candidatesAsViewModels)
